...
input_header = "SCZ_DER22_output/Schizophrenia_Pardinas_2018.DER22"
out_header = "SCZ_DER22_output_step3/SCZ_DER22"

### if the folder SCZ_DER22_output_step3 does not exist, please use dir.create("SCZ_DER22_output_step3") to create it.
